...
@Component({
  selector: 'app-nuevo-tipo-de-personal',
  templateUrl: './nuevo-tipo-de-personal.component.html',
  styleUrls: ['./nuevo-tipo-de-personal.component.scss']
})
export class NuevoTipoDePersonalComponent implements OnInit {
