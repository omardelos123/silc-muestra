...
@Component({
  selector: 'app-nuevo-tipo-de-sistemas',
  templateUrl: './nuevo-tipo-de-sistemas.component.html',
  styleUrls: ['./nuevo-tipo-de-sistemas.component.scss']
})
export class NuevoTipoDeSistemasComponent implements OnInit {
