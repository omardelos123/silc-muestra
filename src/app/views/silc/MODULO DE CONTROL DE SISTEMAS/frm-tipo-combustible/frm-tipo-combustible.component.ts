...
@Component({
  selector: 'app-frm-tipo-combustible',
  templateUrl: './frm-tipo-combustible.component.html',
  styleUrls: ['./frm-tipo-combustible.component.scss']
})
export class FrmTipoCombustibleComponent implements OnInit {
