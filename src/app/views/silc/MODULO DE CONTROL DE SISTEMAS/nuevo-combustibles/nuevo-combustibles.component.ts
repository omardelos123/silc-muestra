...
@Component({
  selector: 'app-nuevo-combustibles',
  templateUrl: './nuevo-combustibles.component.html',
  styleUrls: ['./nuevo-combustibles.component.scss']
})
export class NuevoCombustiblesComponent implements OnInit {
