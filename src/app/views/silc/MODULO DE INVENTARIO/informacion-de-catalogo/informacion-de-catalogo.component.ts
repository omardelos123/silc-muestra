...
@Component({
  selector: 'app-informacion-de-catalogo',
  templateUrl: './informacion-de-catalogo.component.html',
  styleUrls: ['./informacion-de-catalogo.component.scss']
})
export class InformacionDeCatalogoComponent implements OnInit {
  ...
  flag: boolean = false;
  estatus_crear_pantalla:number=0
  ...
  proveedor_crear: string;
  numero_de_parte_crear: string;
    ...
    this.route.params.subscribe(params => {
      if (params['data'] != null) {
        try {
          ...
          this.solicitud.id_proveedor = JSON.parse(decodeURIComponent(escape(window.atob(params['data'])))). proveedor_crear;
          this.solicitud.nombre = JSON.parse(decodeURIComponent(escape(window.atob(params['data'])))).numero_de_parte_crear;
          this.solicitud.precio_unitario_base = JSON.parse(decodeURIComponent(escape(window.atob(params['data'])))).precio_unitario_crear;
           this.estatus_crear_pantalla = JSON.parse(decodeURIComponent(escape(window.atob(params['data'])))).estatus_crear;
           this.solicitud.id_parte = JSON.parse(decodeURIComponent(escape(window.atob(params['data'])))).id_parte_crear;
          // alert(""+JSON.parse(decodeURIComponent(escape(window.atob(params['data'])))).id_parte_crear );
          //this.BtnVisibles();
  ...
  limpiar(FRM) {
    ...
    this.solicitud.cant_autorizada = 0;
    this.solicitud.disponible = 0;
    this.solicitud.min_permitida = 0;
