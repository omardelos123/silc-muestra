...
@Component({
  selector: 'app-nuevo-almacen-compania',
  templateUrl: './nuevo-almacen-compania.component.html',
  styleUrls: ['./nuevo-almacen-compania.component.scss']
})
export class NuevoAlmacenCompaniaComponent implements OnInit {
