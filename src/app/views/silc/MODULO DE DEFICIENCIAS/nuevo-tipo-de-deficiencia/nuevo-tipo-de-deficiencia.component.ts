...
@Component({
  selector: 'app-nuevo-tipo-de-deficiencia',
  templateUrl: './nuevo-tipo-de-deficiencia.component.html',
  styleUrls: ['./nuevo-tipo-de-deficiencia.component.scss']
})
export class NuevoTipoDeDeficienciaComponent implements OnInit {
